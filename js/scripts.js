...
(function ($) {
    ...
    jQuery(document).ready(function () {
       ...
       /* Mobile Navigation Hide or Collapse on Click */
        ...
        $(".typing").typed({
            strings: ["A lie can be halfway round the world", "before the truth has got its boots on."],    /* You can change the home section typing text from
        ...
        $('.statistics').appear(function() {
         ...
         $('#my-address').gMap({
            ...
            html: "<b>Address</b>: <br>  Kalifornia, U.S.A.",   /* You can change display address text from here */
            popup: true
            }
            ]
            });
